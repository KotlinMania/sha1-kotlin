...
This file is the quick-reference operating contract for sha1-kotlin. The longer
...
sha1-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`sha1`](https://crates.io/crates/sha1). Upstream Rust is the behavioral oracle while the
